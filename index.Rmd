...
<a href="reportRxRMarkdownDemo.Rmd" target="_blank">A demo RMarkdown document show casing the reportRx functions is available here.</a> 
...
A simple example is available <!--[here](simpleYAML.Rmd)--> <a href="simpleYAML.Rmd" target="_blank">here</a> and a more comprehensive example is <!--[here](comprehensiveYAML.Rmd)--> <a href="comprehensiveYAML.Rmd" target="_blank">here</a>
...
Regular Latex-style formulas can be easily written in R markdown. Use single `$` for inline expresssions and `$$` for enclosing standalone expressions.
...
Retrieve the column numbers corresponding to Excel column headers. This can be useful if variables are refered to by Excel column names in the statistical analysis plan.
...
If you would like to log issues using your uhnresearch email (and your real name!) will help us to prioritise issues arising from within the department.
